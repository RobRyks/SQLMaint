...
#reset error count
$error.clear()
$jobname ='DBA-BkupUserDBFull'
$step1 = @"
sqlcmd -E -S `$(ESCAPE_SQUOTE(SRVR)) -d master -Q "EXECUTE [dbo].[DatabaseBackup] @Databases = 'USER_DATABASES', @Directory = N'$backupdir', @BackupType = 'FULL', @Verify = 'Y', @CleanupTime = $bkupdelhours, @CheckSum = 'Y', @Compress = 'Y', @LogToTable = 'Y'" -b
"@
...
if (($servername.Length -eq 0) -or ($backupdir.Length -eq 0) ) {
