function BkupSysDBFull { [CmdletBinding()]
    param (
            [string]$servername,
            [string]$instance,
            [timespan]$starttime,
...
#reset error count
$error.clear()
$jobname ='DBA-BkupSysDBFull'
$step1 = @"
sqlcmd -E -S `$(ESCAPE_SQUOTE(SRVR)) -d master -Q "EXECUTE [dbo].[DatabaseBackup] @Databases = 'SYSTEM_DATABASES', @Directory = N'$backupdir', @BackupType = 'FULL', @Verify = 'Y', @CleanupTime = $BkupDelHours, @CheckSum = 'Y', @LogToTable = 'Y'" -b
"@
